...
class TestTableOfContents:
    ...
    def test_simple_toc_structure(self):
        ...
        [doc, toc] = self.create_doc_structure()
    ...
    def test_toc_level_to_include(self):
    ...
    def test_without_anchor_generation_for_toc(self):
    ...
    def test_anchor_generation_for_toc(self):
